...
Four artifacts: an append-only event log, periodic snapshots, one **world manifest** (written synchronously at world creation; everything else is asynchronous), and the dual-slot **durable-frontier record** (below).
