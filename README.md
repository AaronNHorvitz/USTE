...
**Status: R0 design ready; T-08–T-11 workspace, canonical types, logical oracle and encrypted
envelope/key boundary implemented.** There is no database executable, durable transaction path, supported parser,
