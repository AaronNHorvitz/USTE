...
- T-04 has an exact adapter registry, resolved candidate lockfile/native-link/license snapshot,
  clean advisory/license/source policy checks, and logical fixtures for every family. It
  remains unchecked until generated bytes/hashes, reachable unsafe review and supervisor
