...
| Status / ID | Work package and requirement | Depends on | Artifact to produce | Completion evidence |
|---|---|---|---|---|
| [ ] T-20 | Disk-index foundation and bounded cache; FR-16 | T-17, T-18, T-49 | [Versioned graph/index runs](docs/evidence/disk-index-foundation.md), [terminal root deltas](docs/evidence/graph-state-root-deltas.md), [bounded composite preparation](docs/evidence/bounded-composite-preparation.md), [explicit-I/O preparation proofs](docs/evidence/explicit-io-graph-preparation.md) and root publication | VT-05/14 and BM-01/06 verify rebuild, visibility and cache pressure; no full-RAM assumption hidden |
