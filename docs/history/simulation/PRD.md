# Historical design: Universal Spatial-Temporal Engine — Product Requirements Document

> Superseded on 2026-09-16 by [Decision 0001](../../decisions/0001-product-direction.md).
> Preserved from commit `0f96428` as design history, not current requirements or implementation evidence.
