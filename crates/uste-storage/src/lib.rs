...
pub use index::{
    ...
    MAX_INDEX_PREDECESSOR_PAGE_VISITS, MAX_INDEX_RESULT_BYTES, MAX_INDEX_RUN_LOGICAL_BYTES,
    MAX_INDEX_RUNS, MAX_INDEX_SCAN_RESULTS, MAX_INDEX_VALUE_BYTES, MergedIndexRun, PageCache,
    RecoveredIndexRoot,
};
