...
fn sample(
    ...
    Ok(serde_json::json!({
        ...
        "storage_metadata_memory_resident": storage_resident(&session.coordinator),
        "storage_recovery": storage_recovery_json(&session.coordinator)?,
        "authenticated_io_accounting": "partial-cached-primitives",
